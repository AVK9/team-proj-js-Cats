import"./assets/su-31e9c5e8.js";const L=document.querySelector(".shopping-list-empty"),v=document.querySelector(".js-shop-list"),S="user-shopping-list",a=JSON.parse(localStorage.getItem(S));console.log("shopArr",a);console.log(a.length);a.length===0&&L.classList.remove("hidden");const p=document.querySelector(".pagination");p.classList.add("hidden-pagination");const o=document.querySelector(".prev");o.disabled=!0;const r=document.querySelector(".next"),d=document.querySelector(".double-prev");d.disabled=!0;const c=document.querySelector(".double-next"),m=document.querySelector(".buttons-numbers"),n=4;let e=1;function P(t,l=1,s=4){const i=(l-1)*s,f=i+s;return t.slice(i,f).map(({_id:y,list_name:k,amazon_product_url:q,author:E,book_image:x,book_uri:M,contributor:$,description:A,publisher:C,title:j})=>`<li data-id="${y}" class="shopping-list-card js-trash">
            <div class="shopping-list-card-flex"><img class="list-card-img" src="${x}" alt="${E}">
              <div>
