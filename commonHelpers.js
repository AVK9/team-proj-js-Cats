import"./assets/su-48bc8a1f.js";import{a as b,N as f}from"./assets/vendor-77e6b4aa.js";const U="https://books-backend.p.goit.global",q="/books/category-list";async function R(){try{return(await b.get(`${U}${q}`)).data}catch(t){console.error(t)}}document.querySelector(".main-content-page");const Y=document.querySelector(".categories-list");R().then(t=>{P(t)}).catch(t=>{f.Notify.failure("Error"),console.log(t)});function P(t){const e=t.map(({list_name:c})=>`
